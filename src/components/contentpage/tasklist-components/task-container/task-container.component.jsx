...
const TaskContainer = ({ objectData }) => {
  ...
  const deleteRecord = async () => {
    ...
    const response = await fetch(
      "http://node-express-env.eba-cxqhpveg.us-east-1.elasticbeanstalk.com/api/tasks/delete",
      {
        method: "POST",
        headers: {
  ...
  const updateTabName = async (value) => {
    ...
    const response = await fetch(
      "http://node-express-env.eba-cxqhpveg.us-east-1.elasticbeanstalk.com/api/tasks/updateTab",
      {
        method: "POST",
        headers: {
          "Content-type": "application/json",
